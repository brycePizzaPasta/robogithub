...
#define ROBOT_NAME	"Major Meatshot"
#define ROBOT_ROLE "ZBOSS"
#define ROBOT_CLASS "Scout"
#define ROBOT_SUBCLASS "Hitscan"
#define ROBOT_DESCRIPTION "Crit Scattergun, More Jumps"
#define ROBOT_TIPS "Your scattergun always crits\n2 extra air jumps\nSlower fire/reload rate"
...
public OnPluginStart()
{
	...
	AddRobot(robot, MakeGiantscout, PLUGIN_VERSION, restrictions);
}
...
stock GiveGiantPyro(client)
{
	if (IsValidClient(client))
	{
		...
		CreateRoboHat(client, Wraps, 10, 6, 0.0, 1.0, -1.0); //Wipe Out Wraps
		CreateRoboHat(client, Goggles, 10, 6, 0.0, 0.75, 0.0);//Planeswalker Goggles
		CreateRoboHat(client, Peak, 10, 6, 0.0, 1.0, -1.0); //Patriot Peak
		...
		if(IsValidEntity(Scattergun))
		{
			...
			TF2Attrib_SetByName(Scattergun, "air dash count", 2.0);
