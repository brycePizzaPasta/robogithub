...
#define ROBOT_NAME	"Streamliner"
#define ROBOT_ROLE "Damage"
#define ROBOT_CLASS "Demoman"
#define ROBOT_SUBCLASS "Grenades"
#define ROBOT_DESCRIPTION "Rapid-Fire Grenades"
#define ROBOT_TIPS "Your grenade launcher is rapid-fire\nReload entire clip at once"
#define ROBOT_COST 2
#define ROBOT_ON_DEATH "Attack Streamliner during his long reload\nArblast and delete his grenades"
...
#define DecoratedVeteran 31261
#define HawaiianHangover 31274
#define BarefootBrawler 31275
stock GiveGiantDemoKnight(client)
{
	if (IsValidClient(client))
	{
		...
		CreateRoboWeapon(client, "tf_weapon_grenadelauncher", 206, 6, 1, 2, 406);
		//CreateRoboWeapon(client, "tf_weapon_stickbomb", 307, 6, 1, 2, 0);

		CreateRoboHat(client, DecoratedVeteran, 10, 6, 0.0, 1.0, 2.0); 
		CreateRoboHat(client, HawaiianHangover, 10, 6, 0.0, 1.0, -1.0); 
		CreateRoboHat(client, BarefootBrawler, 10, 6, 0.0, 1.0, -1.0);
