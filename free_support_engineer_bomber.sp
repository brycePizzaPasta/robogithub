...
#define HeadOfDefense 31114
#define MiningLight 48
#define Dogfighter 30330
...
stock GiveBigRoboDane(client)
{
	if (IsValidClient(client))
	{
		...
		CreateRoboWeapon(client, "tf_weapon_shotgun_primary", 9, 6, 1, 2, 210);
		...
		CreateRoboHat(client, HeadOfDefense, 10, 6, 6901050.0, 1.0, -1.0);
		CreateRoboHat(client, MiningLight, 10, 6, 0.0, 1.0, -1.0);
		CreateRoboHat(client, Dogfighter, 10, 6, 6901050.0, 1.0, -1.0);
		...
		if(IsValidEntity(Weapon3))
		{
			...
			TF2Attrib_SetByName(Weapon3, "override projectile type", 2.0);
			TF2Attrib_SetByName(Weapon3, "mini rockets", 1.0);
			TF2Attrib_SetByName(Weapon3, "engy sentry fire rate increased", 2.0);
